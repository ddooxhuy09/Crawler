document.addEventListener("DOMContentLoaded", async function () {
  ...
  var iframeSelectorInput = document.getElementById('iframeSelectorInput');
      ...
      chrome.tabs.query(
        ...
        async function (tabs) {
          ...
          if (currentSiteData.length > 0) {
            ...
            selectorInput.value = currentTabSettings.elementSelector || '';
            iframeSelectorInput.value = currentTabSettings.iframeElementSelector || '';
    ...
    chrome.tabs.query(
      ...
      async function (tabs) {
        ...
        var settings = {
          ...
          elementSelector: selectorInput.value,
          iframeElementSelector: iframeSelectorInput.value,
  ...
  function populateSitesTable(data) {
    ...
    data.forEach(function (site) {
      ...
      actionCell.textContent = site.elementSelector;
      row.appendChild(actionCell);

      var IframeCell = document.createElement("td");
      IframeCell.textContent = site.iframeElementSelector;
      row.appendChild(IframeCell);
